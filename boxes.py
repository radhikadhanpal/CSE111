# Purpose : Check your understanding of calling built-in Python 
# functions and functions that are in a standard Python module.
...
items_per_box = int(input(f"Enter the number items per box: "))
